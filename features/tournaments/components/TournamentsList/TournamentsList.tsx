...
export function TournamentsList() {
  ...
  if (loading) {
    return <div className="text-center py-20 text-cc-text-secondary">Loading tournaments...</div>;
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8 font-sans">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-cc-text-primary mb-2">Arena Tournaments</h1>
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-4">
          {tournaments.map(tournament => (
            <Card
              key={tournament.id}
              className="p-4 cursor-pointer hover:border-primary transition-colors flex justify-between items-center"
