          ...
          {loading ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Gold</div>
                  </div>
                </div>
                <div className="bg-slate-800/50 border border-slate-700 p-4 rounded-xl flex flex-col items-center justify-center gap-2">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Aetherium</div>
                  </div>
                </div>
              </div>
              ...
              {/* Items */}
              <div>
                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider mb-3">Items &amp; Cosmetics</h3>
                {inventory.items.length === 0 ? (
                  <div className="text-sm text-slate-400 italic text-center py-4 bg-slate-800/30 rounded-lg border border-slate-800 border-dashed">
                    ...
                    {inventory.items.map(item => (
                      <button
                        ...
                        className={`aspect-square rounded-lg border flex items-center justify-center relative group transition-colors disabled:opacity-50 ${
                          item.equipped ? 'bg-indigo-900/50 border-indigo-500' : 'bg-slate-800 border-slate-700'
                        }`}
                      >
                        ...
                        <div className="absolute hidden group-hover:block bottom-full mb-2 bg-slate-800 text-xs text-white p-2 rounded shadow-lg whitespace-nowrap z-10">
